...
try{
    ...
    if (query[0].price!=Number(AmountPaid)){
      throw new Error("PRICE_MISMATCH");
    }


     const query2=await tx.$queryRaw`INSERT INTO "Booking" (id,"seatId","eventId",status,"pricePaid","createdAt")  VALUES(gen_random_uuid(),${seatId},${eventId},'CONFIRMED',${query[0].price},NOW())`
